...
class TAXLIN(IdTimestampMixin, Base):
    ...
    description: Mapped[str | None] = mapped_column("TAXDSC", String(512))
    usage_note: Mapped[str | None] = mapped_column("TAXUSE", String(512))
    source_label: Mapped[str | None] = mapped_column("TAXSRC", String(255))
